...
const SDG = (props: Props) => {
  ...
  return (
    <section className="w-11/12 bg-base-200 p-4 rounded-2xl mx-auto my-10 lg:w-8/12 lg:bg-transparent lg:rounded-none lg:my-2s0">
      {props.reverse ? (
        <section className="relative flex flex-col-reverse justify-center lg:flex-row-reverse lg:items-center">
          <div className="bg-base-200/80 lg:w-7/12 lg:h-[720px] lg:px-24 lg:py-4 lg:rounded-3xl">
            <div className="text-lg leading-7 p-2 lg:text-2xl lg:leading-[1] lg:py-4 lg:px-2 lg:w-10/12 lg:ml-auto">
              {props?.title && (
                <div className="font-bold text-4xl leading-[2]">
                  {props.title}
                </div>
              )}
              {props.content}
        ...
        <section className="relative flex flex-col-reverse justify-center lg:flex-row lg:items-center">
          <div className="bg-base-200/80 lg:w-7/12 lg:h-[720px] lg:px-24 lg:py-4 lg:rounded-3xl">
            <div className="text-lg leading-7 p-2 lg:text-2xl lg:leading-[1] lg:py-4 lg:w-10/12">
              {props.title && (
